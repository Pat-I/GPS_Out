...
namespace GPS_Out
{
    ...
    */
    ...
    public partial class frmStart : Form
    {
        ...
        public string SenStart
        { get { return cSenStart; } }
        ...
        private void ckGN_CheckedChanged(object sender, EventArgs e)
        {
            Properties.Settings.Default.SendGN = ckGN.Checked;
            if (ckGN.Checked)
            {
                cSenStart = "$GN";
            }
        ...
        private void frmStart_Load(object sender, EventArgs e)
        {
            ...
            ckGN.Checked = Properties.Settings.Default.SendGN;
            ...
            if (Properties.Settings.Default.SendGN)
            {
                cSenStart = "$GN";
            }
            else
        ...
        private void UpdateForm()
        {
            if (this.WindowState != FormWindowState.Minimized)
            {
                if (RollCorrected.Connected() && Properties.Settings.Default.UseRollCorrected)
                {
